...
export default function Products({ navigate }) {
  ...
  useEffect(() => {
    ...
    // Debounce product fetching when typing in search
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-100 pb-5 gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Duyệt qua bộ sưu tập đầy đủ của chúng tôi</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-slate-50 rounded-2xl">
          ...
          <h3 className="text-slate-800 font-bold text-lg">Không tìm thấy sản phẩm</h3>
          <p className="text-slate-400 text-sm mt-1">Hãy thử sử dụng bộ lọc khác hoặc nhập từ khóa khác.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
