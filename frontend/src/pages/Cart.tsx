  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 text-left">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1 mb-0">Kiểm tra lại danh sách các sản phẩm đã chọn</p>
      </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <button
                  ...
                  className="text-slate-400 hover:text-rose-600 transition-colors p-1.5 cursor-pointer bg-transparent border-none"
                  title="Xóa sản phẩm"
                >
